...
const Footer = () => {
  return (
    <>
      <footer className="bg-white py-12 px-6 tracking-wide border border-t">
        <div className="grid max-md:grid-cols-1 max-xl:grid-cols-3 xl:grid-cols-5 xl:gap-20 max-xl:gap-8">
          <div className="max-xl:col-span-full xl:col-span-2">
            <div className="max-xl:max-w-2xl">
              <h2 className="text-3xl mb-6 font-semibold font-basefont">
                Western Gods
              </h2>
              <p className="text-black lg:text-md font-basefont text-md">
                We make Cold Pressed Unrefined Oils like Coconut, Groundnut, Sesame & Castor which is made from hand picked oil seeds. We directly source the oil seeds directly from farmers and from our own farm. Reach us out to know more
              </p>

              {/* <div className="flex flex-col mt-5 min-[470px]:flex-row items-center gap-3 w-full">
                <div className="relative  text-gray-500 focus-within:text-gray-900 max-sm:w-full">
                  ...
                  <input
                    ...
                    placeholder="mail@Western Gods.com"
                  />
                </div>
                <Link
                  to="/login"
                  className="inline-flex text-center uppercase items-center
                            justify-center py-3 px-7 mr-3 before:ease relative h-12 w-40 overflow-hidden border border-gray-500 bg-gray-600
             text-white shadow-2xl transition-all before:absolute before:right-0 before:top-0
              before:h-12 before:w-6 before:translate-x-12 before:rotate-6 before:bg-white
               before:opacity-10 before:duration-700 
          ...
          <div>
            <h4 className="text-lg mb-6 font-basefont uppercase font-semibold text-black ">
              QUICK LINKS
            </h4>
            <ul className="space-y-4">
              <li>
                <a
                  href="/our-story"
                  className="text-black hover:font-semibold hover:text-bluecolor font-basefont"
                >
                  About Us
                </a>
              </li>
          ...
          <div>
            <h4 className="text-lg mb-6 uppercase font-semibold font-basefont text-black ">Support</h4>
            <ul className="space-y-4">
              <li>
                <a
                  href="/privacy-policy"
          ...
          <div>
            <h4 className="text-lg mb-6 font-basefont uppercase font-semibold">Help</h4>
            <p className="font-basefont text-black text-md">
              No: 127, Earipallayam,<br />
              Udumalaipettai,<br />
              Tiruppur,<br />
              Tamil Nadu – 642126
            </p>
        ...
        <p className="text-md font-basefont text-black mt-8">
          © {getYear()}
          <a
            href="/"
            target="_blank"
            className="hover:underline mx-1 text-Western Godsgold"
          >
            Western Gods.
          </a>
          All Rights Reserved.
